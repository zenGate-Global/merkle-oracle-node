...
require (
	...
	github.com/zenGate-Global/cardano-connector-go v0.2.1-0.20251022024620-d1fb5e8ad1df
...
replace github.com/blinklabs-io/plutigo => github.com/blinklabs-io/plutigo v0.0.13
